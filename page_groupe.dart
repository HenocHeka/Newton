...
import 'package:our_social_app/modeles_cartes_poster/salon_carte.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          backgroundColor: Color.fromARGB(255, 12, 17, 22),
        elevation: 0,
        title: Text('Discussion', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
        centerTitle: false,
          actions: [
        ...
        builder: (context,
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  SalonCarte(snap: snapshot.data!.docs[index].data()));
        },
      ),
